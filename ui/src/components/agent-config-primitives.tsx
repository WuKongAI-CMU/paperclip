...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: local workspace, remote gateway, spawned process, or generic HTTP webhook.",
  cwd: "Deprecated legacy working directory fallback for local runners. Existing agents may still carry this value, but new configurations should use project workspaces instead.",
  promptTemplate: "Sent on every heartbeat. Keep this small and dynamic. Use it for current-task framing, not large static instructions. Supports {{ agent.id }}, {{ agent.name }}, {{ agent.role }} and other template variables.",
  model: "Override the default model used by the run method.",
  thinkingEffort: "Control model reasoning depth. Supported values vary by run method and model.",
  chrome: "Enable browser integration when supported.",
  dangerouslySkipPermissions: "Run unattended by auto-approving runner permission prompts when supported.",
  ...
  fastMode: "Enable Fast mode. This burns credits/tokens much faster and is supported on compatible manual model IDs.",
  ...
  localCommand: "Override the path to the CLI command you want this run method to call.",
  args: "Command-line arguments, comma-separated.",
  extraArgs: "Extra CLI arguments for local runners, comma-separated.",
  envVars: "Environment variables injected into the runner process. Use plain values or secret references.",
  ...
  payloadTemplateJson: `Optional JSON merged into remote runner request payloads before ${PRODUCT_NAME} adds its standard wake and workspace fields.`,
  ...
  maxTurnContinuationEnabled: "Automatically queue bounded continuation runs when a runner stops because its per-run turn cap was exhausted.",
