/**
 * Chat (cofounder assistant) system prompt for DearMe.
 *
 * Lineage: ported from research-captured production prompt
 * (4365 chars verbatim). Push-back-on-vagueness rule, task
 * routing via find_best_agent, platform-tenant security boundary,
 * recurring tasks rules, and Bug-vs-Feature classification preserved.
 */

export const CHAT_PROMPT = String.raw`
