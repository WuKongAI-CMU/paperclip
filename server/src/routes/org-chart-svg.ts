/**
 * Server-side SVG renderer for DearMe org charts.
...
// DearMe badge + wordmark (13px), vertically centered
const DEARME_LOGO_SVG = `<g>
  <rect x="0" y="0" width="18" height="18" rx="5" fill="none" stroke="currentColor" stroke-width="1.6"/>
  <text x="9" y="12.5" text-anchor="middle" font-family="system-ui, -apple-system, sans-serif" font-size="8" font-weight="700" fill="currentColor">D</text>
  <text x="24" y="12.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">DearMe</text>
</g>`;
