...
const DearMeSitePreview = lazyNamed(() => import("./pages/DearMeSitePreview"), "DearMeSitePreview");
...
export function BoardAppRoutes() {
  return (
    <Routes>
      <Route path="/" element={<CompanyRootRedirect />} />
      <Route path="onboarding" element={<OnboardingRoutePage />} />
