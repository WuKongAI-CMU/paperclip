...
Last updated: 2026-05-11 (post DM-172B live X dispatch + DM-174 live Resend dispatch proof)
...
customer-facing slice at a time. DM-172 and the Resend half of DM-174 are now
closed on the canonical `ChannelDispatch` path, so the next product-dispatch
gap is DM-176 LinkedIn or DM-177 site deploy, not another connector/settings
surface. Reuse still means adapting Polsia choreography, Lindy
