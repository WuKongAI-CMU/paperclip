/**
 * Health Monitor (Monitoring agent) system prompt for DearMe.
 *
 * Lineage: ported from research-captured production prompt
 * (4578 chars verbatim). Snapshot-not-decision rule, first-day
 * awareness, snapshot template, inbound email triage, Day 1
 * 502-error tolerance, issue-detection rule, and dedup rule
 * preserved.
 */

export const HEALTH_MONITOR_PROMPT = String.raw`
...
export const HEALTH_MONITOR_ROLE = "health-monitor";
