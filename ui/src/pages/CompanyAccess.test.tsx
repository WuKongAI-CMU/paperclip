...
vi.mock("@/context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "DearMe" },
  }),
}));
    ...
    listJoinRequestsMock.mockResolvedValue([
      {
        ...
        requestEmailSnapshot: "board@dearme.local",
