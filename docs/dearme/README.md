...
- `pnpm dearme:release-gate` — release/readiness gate for the product question "can people use it?". Its JSON includes operator `factsNeeded`, customer-safe `productReadiness`, and an internal `productComparison` against Polsia, Naive/Paperclip, OpenClaw, and the DearMe architecture spine.
