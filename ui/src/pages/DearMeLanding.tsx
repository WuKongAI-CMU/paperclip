...
export function DearMeLanding() {
  ...
  function handleInviteRequest(source: "nav" | "footer") {
  ...
  function handleProofClick(source: "nav" | "footer") {
        ...
        <footer className="grid gap-4 border-t border-border py-5 text-sm text-muted-foreground md:grid-cols-[1fr_auto] md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button asChild variant="secondary" size="sm" className="min-h-11">
              <a href="mailto:peter@dearme.app?subject=DearMe%20private%20beta%20invite" onClick={() => handleInviteRequest("footer")}>
                Request invite
                <Mail className="h-4 w-4" />
              </a>
            </Button>
