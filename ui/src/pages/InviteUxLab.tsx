...
import { PRODUCT_ACCOUNT_LABEL, PRODUCT_NAME } from "@/lib/product-labels";
  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">You&apos;ve been invited to join {PRODUCT_NAME}</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? `Start with a ${PRODUCT_ACCOUNT_LABEL}. After that, you'll come right back here to accept the invite for Acme Robotics.`
        ...
        <div className="flex min-h-[420px] flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? `Sign in to ${PRODUCT_NAME}` : `Create your ${PRODUCT_ACCOUNT_LABEL}`}
            </h3>
      ...
      <Card className="rounded-[28px] shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            ...
            >
              https://dearme.local/invite/new-token
            </button>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description={`Create your ${PRODUCT_ACCOUNT_LABEL} first. If you already have one, switch to sign in and continue the invite with the same email.`}
